...
// developments.
#define EEPROM_ADDR_VERSION 4
#define EEPROM_ADDR_GLOBAL 16
#define EEPROM_ADDR_PARAMETERS 100
#define EEPROM_ADDR_STARTUP_BLOCK 140
#define EEPROM_ADDR_BUILD_INFO 256
...
void settings_clear_startup_line(void);
